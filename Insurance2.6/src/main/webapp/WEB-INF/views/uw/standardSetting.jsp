	...
	<div class="container w-25 mt-5">
		...
		<form action="standardSetting.do" class="mt-5" name="StandardSetting" method="POST">
			<div class="mb-3">
				...
				<input type="text" class="form-control" name="CustomerMinAge" placeholder="숫자만 입력하세요" onKeyPress="return checkNum(event)" onkeyup="return del(event)">
			</div>
			<div class="mb-3">
				<label for="age" class="form-label mb-2">최대 가입 가능 나이</label>
				<input type="text" class="form-control" name="CustomerMaxAge" placeholder="숫자만 입력하세요" onKeyPress="return checkNum(event)" onkeyup="return del(event)">
			</div>
			...
			<div class="text-center">
				<button type="submit" class="btn btn-primary" name="SubmitBtn"  onClick="return setting()">확인</button>
