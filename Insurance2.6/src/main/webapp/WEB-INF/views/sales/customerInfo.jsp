...
<body>
	<div class="container w-25 mt-5">
		...
		<form action="customerInfo.do" class="mt-5" name="CustomerInfo" method="POST">
			<div class="mb-3">
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" name="Age" placeholder="숫자만 입력하세요" onKeyPress="return checkNum(event)" onkeyup="return del(event)">
			</div>
			...
			<div class="text-center">
				<button type="submit" class="btn btn-primary" name="SubmitBtn" onClick="return cusInfo()">확인</button>
