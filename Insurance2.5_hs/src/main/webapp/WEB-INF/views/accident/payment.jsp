...
<body>
	<div class="container w-25 mt-5">
		...
		<form class="mt-5" name="Payment" method="POST">
			...
			<div class="mb-3">
				<label for="check" class="form-label mb-2">예상 보상 금액</label> <button type="submit" class="btn btn-warning btn-sm mb-2" name="PayCheckBtn" formaction="checkPrice.do">금액 확인</button>
				<input type="text" class="form-control" name = "RewardPrice" placeholder="숫자만 입력하세요" value = "${RewardPrice}">
			</div>
			<div class="mb-5">
