	...
	<div class="container w-25 mt-5">
		...
		<form action="receipt.do" class="mt-5" name="Receipt" method="POST" id="form">
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" name="DamagePrice" placeholder="숫자만 입력해주세요.">
			</div>
			...
			<div class="text-center">
				<button type="submit" class="btn btn-primary" name="SubmitBtn" onClick="alertBtn()">접수 완료</button>
