...
<body>
	...
	<div class="container w-25 mt-5">
		...
		<form action="form1" class="mt-5" name="PredictProfit" method="POST">
			...
			<div class="mb-3">
				<label for="totalPrice" class="form-label mb-2">손익 예측</label><button type="submit" class="btn btn-danger btn-sm mb-2 mx-2" name="SubmitBtn" formaction="predict.do">손익 분석</button>	
				<input type="text" class="form-control" name="TotalProfit" placeholder="숫자만 입력하세요" value = "${totalProfit}">
			</div>

			<div class="text-center">				
				<button type="submit" class="btn btn-primary" name="CalculateBtn" onclick="alertBtn()" formaction="setPredict.do">보험 설계완료</button>
